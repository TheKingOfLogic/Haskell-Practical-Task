...
main = do
    ...
    let players = [("Alice",50),("Bob",75),("Carol",60),("Dan",40)]
    print (getTopThreePlayers players)  -- ["Bob","Carol","Alice"]

    putStrLn "\n=== HC1T5: Laziness (First N Numbers) ==="
    ...
    print (applyTwice increment 3)  -- 5
